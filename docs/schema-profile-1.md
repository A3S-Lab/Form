...
Use `compileForm`, the compiler Worker, or `a3s-form validate` as the authority. Do not preflight a document with a different validator and assume that it is accepted by A3S Form.
