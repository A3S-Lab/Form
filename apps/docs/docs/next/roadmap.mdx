...
A3S Form documents will not execute arbitrary JavaScript. Form Core will not duplicate identity, secrets, submission storage, payments, analytics, or connector platforms. Those services belong to A3S Cloud, A3S Workflow, or another host behind explicit capabilities.
