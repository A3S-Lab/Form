...
const output = openSync(resolve(runtimeRoot, 'playground.out.log'), 'a');
const errorOutput = openSync(resolve(runtimeRoot, 'playground.err.log'), 'a');
const child = spawn(process.execPath, ['scripts/serve-playground.mjs'], {
  cwd: projectRoot,
  detached: true,
