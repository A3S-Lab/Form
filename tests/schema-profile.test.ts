...
describe('A3S Form Schema Profile 1', () => {
  ...
  it.each([
    ...
    ['a non-JSON default', { default: Number.NaN }, 'schema.keyword.invalid'],
    ['a non-JSON const', { const: () => undefined }, 'schema.keyword.invalid'],
    ['a non-array enum', { enum: 'one' }, 'schema.keyword.invalid'],
    ['an empty enum', { enum: [] }, 'schema.keyword.invalid'],
    ['an enum with non-JSON data', { enum: [undefined] }, 'schema.keyword.invalid'],
    ...
    ['a non-finite minimum', { minimum: Number.NaN }, 'schema.keyword.invalid'],
